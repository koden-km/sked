<?php
namespace Icecave\Sked\TypeCheck\Exception;

final class UnexpectedArgumentValueException extends UnexpectedInputException
{
    public function __construct($parameterName, $index, $value, $expectedType, \Exception $previous = null, \Icecave\Sked\TypeCheck\TypeInspector $typeInspector = null)
    {
        if (null === $typeInspector) {
            $typeInspector = new \Icecave\Sked\TypeCheck\TypeInspector();
        }
