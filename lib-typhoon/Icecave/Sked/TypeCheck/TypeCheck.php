...
abstract class TypeCheck
{
    ...
    {
        $validatorClassName = '\\Icecave\\Sked\\TypeCheck\\Validator\\' . $className . 'TypeCheck';
    ...
    {
        return new \Eloquent\Typhoon\Configuration\RuntimeConfiguration(\Eloquent\Cosmos\ClassName::fromString('\\Icecave\\Sked\\TypeCheck'), true);
    }
